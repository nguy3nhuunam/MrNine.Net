...
export const motionControlModels: ReadonlyArray<FalModel> = [
  {
    ...
    vendor: "Kuaishou",
    tagline: "Chuyển chuyển động từ video tham chiếu sang nhân vật trong ảnh",
    badge: "NEW",
    ...
    imageKey: "image_url",
    imageLabel: "Ảnh nhân vật (URL)",
    outputKind: "video",
    params: [
      { key: "video_url", label: "Video tham chiếu (URL)", type: "string", default: "", hint: "URL video chứa chuyển động cần chuyển" },
      { key: "character_orientation", label: "Hướng nhân vật", type: "select", default: "match_reference", options: [
        { value: "match_reference", label: "Khớp video tham chiếu" },
