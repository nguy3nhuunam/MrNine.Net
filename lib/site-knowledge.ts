...
const moduleEntries: ReadonlyArray<ModuleEntry> = [
  ...
  },
  {
    ...
    route: "/tools",
    shortcut: "-",
    summaryVi: "Hộp 10 công cụ thực dụng cho người Việt, chạy hoàn toàn client-side. Không gửi dữ liệu ra server.",
    capabilitiesVi: [
      "Văn bản: đếm chữ (ký tự, từ, câu, đoạn, byte UTF-8, thời gian đọc); slug VN-aware (bỏ dấu tiếng Việt → kebab-case); đổi case (UPPER/lower/Title/camel/Pascal/snake/kebab/CONSTANT); markdown live preview; diff so sánh hai đoạn (LCS, highlight thêm/xoá).",
      "Số: số → chữ tiếng Việt (đọc tiền VND cho hợp đồng/hoá đơn/séc, hỗ trợ đến hàng triệu tỷ).",
      "An toàn: sinh mật khẩu mạnh (length 6-64, charset configurable, đo entropy weak/fair/strong/excellent).",
      "Thiết kế: color picker HEX↔RGB↔HSL + Tailwind class + CSS var; WCAG contrast checker AA/AAA cho text thường + lớn, có preview.",
      "Thời gian: timestamp converter Unix↔ISO↔giờ Việt Nam↔Bangkok↔relative.",
    ],
    howVi: "Mở /tools, chọn tab (gom theo Văn bản / Số / An toàn / Thiết kế / Thời gian). Nhập dữ liệu, kết quả update realtime. Có nút Copy mọi kết quả.",
  },
  {
    title: "Calculators",
    status: "live",
