...
const moduleEntries: ReadonlyArray<ModuleEntry> = [
  ...
  },
  {
    ...
    route: "/tools",
    shortcut: "-",
    summaryVi: "Hộp 12 công cụ thực dụng cho người Việt, sắp lưới 4×3, chạy hoàn toàn client-side. Không gửi dữ liệu ra server.",
    capabilitiesVi: [
      "Đếm chữ: ký tự, từ, câu, đoạn, dòng, byte UTF-8, thời gian đọc.",
      "Slug VN: bỏ dấu tiếng Việt → kebab-case (dùng cho URL bài viết, sản phẩm).",
      "Đổi case: UPPER, lower, Title, camelCase, PascalCase, snake_case, kebab-case, CONSTANT.",
      "Markdown: live preview headings, list, link, code.",
      "So sánh (Diff): LCS giữa hai đoạn, highlight thêm/xoá.",
      "Số → chữ tiếng Việt: đọc số tiền VND cho hợp đồng/hoá đơn/séc, hỗ trợ đến hàng triệu tỷ.",
      "Mật khẩu: sinh mật khẩu mạnh (length 6-64, charset configurable, đo entropy weak/fair/strong/excellent).",
      "QR Code: sinh mã QR cho link, văn bản, WiFi (SSID + mật khẩu, mạng ẩn), vCard (danh thiếp), kích thước 120-520px, tải PNG.",
      "Color picker: HEX↔RGB↔HSL + Tailwind class + CSS var.",
      "Contrast WCAG: kiểm tra AA/AAA cho text thường + lớn, có preview cặp màu.",
      "Tính ngày: khoảng cách 2 ngày (năm/tháng/ngày + tổng ngày + tuần), tính tuổi + sinh nhật kế tiếp, cộng/trừ ngày-tuần-tháng-năm từ một mốc.",
      "Timestamp: Unix↔ISO↔giờ Việt Nam↔Bangkok↔relative.",
    ],
    howVi: "Mở /tools, bấm 1 trong 12 thẻ ở lưới 4×3 để chuyển công cụ. Nhập dữ liệu, kết quả update realtime. Có nút Copy mọi kết quả.",
  },
  {
    title: "Calculators",
    status: "live",
