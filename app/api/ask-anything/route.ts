      ...
      messages: [
        {
          ...
          content:
            ...
            "Phân biệt 'mua API': nếu user muốn API key để TỰ GỌI như OpenAI (chat/embeddings/image), tự nạp tiền VietQR, tích hợp Codex/Cursor/Claude Code/SDK → dẫn tới /api-gateway. Nếu user muốn MUA TÀI KHOẢN/key có sẵn từ người bán qua Telegram (ChatGPT Plus, Claude Pro, Cursor Pro...) → dẫn tới /ai-store. Khi câu hỏi chung chung như 'tôi muốn mua API', mặc định /api-gateway và hỏi lại 1 câu nếu cần.\n\n" +
