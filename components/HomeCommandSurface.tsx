...
const modules = [
  ...
  },
  {
    number: "02",
    title: "Writer Studio",
    detail: "Long-form · script · copy",
    summary: "Studio viết dài: bài blog, kịch bản, email, copy ads với plot và memory dự án.",
    signal: "Narrative engine",
    action: "Launch writer",
    icon: PenLine,
    accent: "lime",
    shortcut: "2",
    lastUsed: "1 hr",
  ...
  },
  {
    number: "04",
    title: "Doc Hub",
    detail: "PDF · OCR · summarize",
    summary: "Đọc, tóm tắt, dịch và hỏi đáp PDF / Word / slide. Quét ảnh thành text bằng OCR.",
    signal: "Doc pipe",
    action: "Coming soon",
    icon: ScanLine,
    accent: "cyan",
  ...
  },
  {
    ...
    detail: "Notes · RAG · search",
    summary: "Bộ nhớ kiến thức cá nhân: ingest tài liệu, search ngữ nghĩa, hỏi đáp xuyên file.",
    signal: "Vector store",
    action: "Coming soon",
    icon: Brain,
    accent: "lime",
  ...
  },
  {
    number: "06",
    title: "Slide Forge",
    detail: "Outline → keynote",
    summary: "Tạo slide / keynote chỉn chu từ outline hoặc tài liệu nguồn, có chart + theme.",
    signal: "Slide builder",
    action: "Coming soon",
    icon: Presentation,
    accent: "amber",
    shortcut: "6",
  ...
  },
  {
    number: "07",
    title: "Code Workshop",
    detail: "Review · scaffold · test",
    summary: "Trợ lý code: review PR, scaffold component, refactor và sinh test tự động.",
    signal: "Dev lane",
    action: "Coming soon",
    icon: Code2,
    accent: "cyan",
  ...
  },
  {
    number: "08",
    title: "Tool Belt",
    detail: "BG remove · convert · OCR",
    summary: "Bộ tool nhanh: tách nền, scan PDF, convert format, watermark, nén ảnh, gộp file.",
    signal: "Quick tools",
    action: "Coming soon",
    icon: Wrench,
    accent: "red",
...
const moduleCopy = {
  ...
  vi: {
    ...
    "Writer Studio": {
      title: "Writer Studio",
      detail: "Long-form · kịch bản · copy",
      summary: "Studio viết dài: bài blog, kịch bản, email, copy ads với plot và memory dự án.",
      signal: "Máy viết",
      action: "Mở Writer",
    },
    ...
    "Slide Forge": {
      title: "Slide Forge",
      detail: "Outline → keynote",
      summary: "Tạo slide / keynote chỉn chu từ outline hoặc tài liệu nguồn, có chart và theme.",
      signal: "Bộ tạo slide",
      action: "Sắp ra mắt",
    },
    "Code Workshop": {
...
export function HomeCommandSurface() {
  ...
  function openModule(title: string) {
    const destinations: Record<string, string> = {
      ...
      "Writer Studio": "/story-forge",
      "Voice Lab": "/voice-studio",
    };
                  ...
                  return (
                    <motion.button
                      ...
                      className={cn(
                        ...
                        module.title !== "Writer Studio" &&
                          module.title !== "Voice Lab" &&
