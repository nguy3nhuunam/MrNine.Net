...
const modules = [
  ...
  },
  {
    number: "02",
    title: "Brand Lab",
    detail: "Tên brand · slogan · SEO",
    summary: "Đặt tên thương hiệu theo concept, sinh slogan, hashtag IG/TikTok và meta SEO chuẩn.",
    signal: "Naming engine",
    action: "Coming soon",
    icon: Palette,
    accent: "amber",
    shortcut: "2",
  ...
  },
  {
    number: "03",
    title: "Recipe Pal",
    detail: "Nguyên liệu → 3 món",
    summary: "Nhập / chụp nguyên liệu trong tủ lạnh, AI gợi ý 3 món, meal plan tuần và grocery list.",
    signal: "Bếp AI",
    action: "Coming soon",
    icon: ChefHat,
    accent: "lime",
  ...
  },
  {
    number: "04",
    title: "Tarot & Tử Vi",
    detail: "Tarot · tử vi · đặt tên",
    summary: "Bốc tarot 3 lá, xem tử vi 2026, số học (numerology) và đặt tên con theo ngũ hành.",
    signal: "Mystic deck",
    action: "Coming soon",
    icon: Moon,
    accent: "cyan",
  ...
  },
  {
    number: "05",
    title: "CV Forge",
    detail: "CV · cover letter · phỏng vấn",
    summary: "Sinh CV theo template, cover letter cá nhân hoá và bộ 30 câu phỏng vấn theo ngành.",
    signal: "Career desk",
    action: "Coming soon",
  ...
  },
  {
    ...
    detail: "Cold · reply · follow-up",
    summary: "Cold email, trả lời, nhắc lại theo tone (formal / casual / persuasive) và đa ngôn ngữ.",
    signal: "Inbox tool",
    action: "Coming soon",
    icon: Mail,
    accent: "lime",
  ...
  },
  {
    number: "07",
    title: "Meeting Recap",
    detail: "Transcript → action items",
    summary: "Paste transcript hoặc link YouTube, AI tóm tắt theo bullet và liệt kê action items rõ chủ.",
    signal: "Recap engine",
    action: "Coming soon",
    icon: ListChecks,
    accent: "amber",
  ...
  },
  {
    number: "08",
    title: "Study Buddy",
    detail: "Giải đề · IELTS · flashcard",
    summary: "Chụp đề bài → giải từng bước, chấm IELTS Writing/Speaking, biến note thành flashcard.",
    signal: "Tutor lane",
    action: "Coming soon",
    icon: GraduationCap,
    accent: "cyan",
