...
const swCopy = {
  vi: {
    ...
    authorIntentShort: "Ý đồ tác giả",
    currentFocusShort: "Trọng tâm hiện tại",
    characterGraph: "Sơ đồ nhân vật",
    characterGraphEmpty: "Chưa có nhân vật. Architect sẽ sinh khi tạo book.",
    castColumnTitle: "Nhân vật",
    relColumnTitle: "Quan hệ",
    castName: "Tên nhân vật",
    castProfile: "Profile / mô tả",
    castAdd: "Thêm",
    relFrom: "From",
    relTo: "To",
    relLabelPh: "Label (tuỳ chọn)",
    relAdd: "Thêm quan hệ",
    statsTotalChapters: "Tổng chương",
    statsTotalWords: "Tổng chữ",
    statsAvgScore: "Audit score TB",
    statsAvgAi: "AI-tell TB",
    statsLoad: "Tải stats",
    statsWordsPerChapter: "Chữ / chương",
    statsCumulativeMax: "Cumulative max",
    statsAiPerChapter: "AI-tell / chương",
    searchPlaceholder: "Tìm xuyên truyện (tối thiểu 2 ký tự)...",
    searchInMeta: "Trong metadata",
    searchInTruth: "Trong truth files",
    searchInChapter: "Trong chương",
    searchEmpty: "Không có kết quả khớp.",
    searchBtn: "Search",
    bulkOpsTitle: "Bulk operations",
    architectRerun: "Architect re-run",
    bulkApprove: "Bulk approve",
    duplicateBook: "Duplicate book",
    coverTitle: "Cover generator",
    coverPromptPh: "Prompt cho cover (English, ~50–90 từ)...",
    coverRender: "Render cover (Imagen 4)",
    coverDownload: "Tải về",
    foreshadowTitle: "Foreshadow",
    foreshadowSummaryPh: "Mô tả foreshadow / hook",
    foreshadowChapterPh: "Dự kiến đóng ở chương...",
    foreshadowAdd: "Thêm",
    volumesTitle: "Volumes",
    volumeTitlePh: "Tên quyển",
    volumeSummaryPh: "Tóm tắt quyển",
    volumeStartPh: "Bắt đầu",
    volumeEndPh: "Kết (tuỳ chọn)",
    volumeAdd: "Thêm quyển",
    shortHookLines: "Câu hook",
    shortCoverPrompt: "Cover prompt",
    sectionStoryBible: "Story bible",
    sectionBookRules: "Book rules",
    sectionVolumeOutline: "Volume outline",
    sectionStyleGuide: "Style guide",
    sectionCast: "Nhân vật",
    chapterEdit: "Chỉnh sửa chương",
    notesLabel: "Ghi chú chương",
    notesPlaceholder: "Ghi chú riêng (không dùng cho writer)...",
    readingMode: "Chế độ đọc",
    readingExit: "Thoát đọc",
    antiAi: "Anti-AI rewrite",
  },
  en: {
    back: "Back to home",
    title: "Story Writer",
    ...
    authorIntentShort: "Author intent",
    currentFocusShort: "Current focus",
    characterGraph: "Character graph",
    characterGraphEmpty: "No characters yet. Architect will generate them on book creation.",
    castColumnTitle: "Characters",
    relColumnTitle: "Relationships",
    castName: "Character name",
    castProfile: "Profile",
    castAdd: "Add",
    relFrom: "From",
    relTo: "To",
    relLabelPh: "Label (optional)",
    relAdd: "Add relationship",
    statsTotalChapters: "Total chapters",
    statsTotalWords: "Total words",
    statsAvgScore: "Avg audit score",
    statsAvgAi: "Avg AI-tell",
    statsLoad: "Load stats",
    statsWordsPerChapter: "Words / chapter",
    statsCumulativeMax: "Cumulative max",
    statsAiPerChapter: "AI-tell / chapter",
    searchPlaceholder: "Search across the book (min 2 chars)...",
    searchInMeta: "In metadata",
    searchInTruth: "In truth files",
    searchInChapter: "In chapters",
    ...
    duplicateBook: "Duplicate book",
    coverTitle: "Cover generator",
    coverPromptPh: "Cover prompt (English, ~50–90 words)...",
    coverRender: "Render cover (Imagen 4)",
    coverDownload: "Download",
    foreshadowTitle: "Foreshadow",
    foreshadowSummaryPh: "Foreshadow / hook description",
    foreshadowChapterPh: "Resolve at chapter...",
    foreshadowAdd: "Add",
    volumesTitle: "Volumes",
    volumeTitlePh: "Volume title",
    volumeSummaryPh: "Volume summary",
    volumeStartPh: "Start",
    volumeEndPh: "End (optional)",
    volumeAdd: "Add volume",
    shortHookLines: "Hook lines",
    shortCoverPrompt: "Cover prompt",
    sectionStoryBible: "Story bible",
    sectionBookRules: "Book rules",
    sectionVolumeOutline: "Volume outline",
    ...
    notesLabel: "Chapter notes",
    notesPlaceholder: "Private notes (not used by writer)...",
    readingMode: "Reading mode",
    readingExit: "Exit reading",
    antiAi: "Anti-AI rewrite",
  },
    ...
    <main className="relative flex h-screen flex-col overflow-hidden bg-[#0b0a08] text-[#e8dfd4]">
      ...
      <header className="relative z-20 flex h-14 shrink-0 items-center gap-3 border-b border-[#25211b] bg-[#0a0907]/92 px-3 backdrop-blur md:px-5">
        ...
        <Link
          ...
          className="flex items-center gap-2.5 rounded-md outline-none transition hover:opacity-90 focus-visible:ring-2 focus-visible:ring-[#ef4444]/70"
        >
          ...
          <div className="flex-1 space-y-4 overflow-y-auto px-4 py-4 md:px-5">
            ...
            {bookDetail ? (
              <div className="rounded-md border border-[#25211b] bg-[#0d0b08]/82 p-3">
                ...
                <div className="mt-3">
                  <label className="mb-1 block font-mono text-[0.55rem] uppercase tracking-[0.16em] text-[#9a9087]">{copy.authorIntentShort}</label>
                  <textarea
                ...
                <div className="mt-2">
                  <label className="mb-1 block font-mono text-[0.55rem] uppercase tracking-[0.16em] text-[#9a9087]">{copy.currentFocusShort}</label>
                  <textarea
